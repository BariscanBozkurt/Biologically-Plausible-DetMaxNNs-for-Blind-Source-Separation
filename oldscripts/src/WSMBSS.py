...
class OnlineWSMBSS:
    ...
    def fit_next_nnantisparse(self, x_current, neural_dynamic_iterations = 750, use_adam_opt = False,
                              adam_opt_params = {'beta1':0.9, 'beta2':0.99, 'eps': 1e-8}, 
                              neural_lr_start = 0.2, neural_lr_stop = 0.05):
        ...
        h,y, oc = self.run_neural_dynamics_nnantisparse_jit(x_current = x_current, h = h, 
                                                            ...
                                                            adam_beta2 = adam_opt_params['beta2'], 
                                                            adam_eps = adam_opt_params['eps'])
