...
class OnlineNSM:
    ...
    def fit_batch_nsm(self, X, n_epochs = 1, neural_dynamic_iterations = 250, shuffle = True, 
                      debug_iteration_point = 10000, plot_in_jupyter = False):
