...
pickle_name_for_results = "simulation_results_correlated_nnantisparseV7.pkl"
...
seed_list = np.array([1007*i for i in range(25, NumAverages+26)]) ## Seeds for reproducibility
########################################################################################
########################################################################################
###                                                                                  ###
###                        SIMULATION                                                ###
