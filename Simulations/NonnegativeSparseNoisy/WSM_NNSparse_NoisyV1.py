...
pickle_name_for_results = "simulation_results_nnsparse_noisyV1.pkl"
...
seed_list = np.array([14625897 * i for i in range(NumAverages)]) ## Seeds for reproducibility
